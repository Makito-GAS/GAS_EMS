              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  {isEditing ? (
                    ...
                    <p className="font-medium text-gray-800 dark:text-white">{profileData.phone}</p>
                  )}
                </div>
                <div>
                  ...
                  {isEditing ? (
                    ...
                    <p className="font-medium text-gray-800 dark:text-white">{profileData.department}</p>
                  )}
                </div>
                <div>
                  ...
                  {isEditing ? (
                    ...
                    <p className="font-medium text-gray-800 dark:text-white">{profileData.employeeId}</p>
                  )}
                </div>
              </div>
            </div>
